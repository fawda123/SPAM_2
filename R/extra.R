...
plot_adcp(adcp_dat[1, ], shp_in =  shp, loc_in = loc, barcol = rainbow(100)[1:7])

pdf('figs/test.pdf', width = 5.5, height = 12, family = 'serif')
# tiff('figs/test.tif', width = 8, height = 7, units = 'in', res = 300, compression = 'lzw', family = 'serif')

get_multi(adcp_dat[1:10, ], shp_in = shp, loc_in = loc, interp = 4, col_vec = c('red', 'green'))
